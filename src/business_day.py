...
holidays_2022=["2022-01-03","2022-01-31","2022-02-01","2022-02-02","2022-02-03","2022-02-04","2022-04-04","2022-04-05","2022-05-02","2022-05-03","2022-05-04","2022-06-03",
...
def get_business_day_cn(year="all"):
    ...
    if year=="2021":
        ...
        return CustomBusinessDay(holidays=[*holidays_2019,*holidays_2020,*holidays_2021,*holidays_2022])
